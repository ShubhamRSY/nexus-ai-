...
def seed_demo_data() -> None:
    ...
    if not tenant:
        ...
        articles = [
            ...
            {"title": "API rate limits and best practices", "content": "The Nexus API allows 1,000 requests per minute for enterprise plans and 100 requests per minute for standard plans. Implement exponential backoff for retries. Cache responses where possible. Include your API key in the X-API-Key header. Monitor your usage from the Developer Dashboard.", "tags": "api,developer,rate-limit", "category": "technical"},
            {"title": "Supported browsers", "content": "Nexus Cloud supports the latest two major versions of Chrome, Firefox, Safari, and Edge. For the best experience, enable JavaScript and cookies. Internet Explorer is not supported.", "tags": "browser,support,technical", "category": "technical"},
            ...
            {"title": "Contacting Nexus Support", "content": "Nexus Support is available via chat, email, and enquiry form. Chat: use the in-app console. Email: hello@nexus.com. Enterprise customers can send an enquiry from /contact for dedicated support. Average response time is under 2 minutes for chat and under 4 hours for email.", "tags": "support,contact,help", "category": "general"},
        ]
        for art in articles:
    ...
    conversations = [
        ...
        },
        {
            ...
            "messages": [
                ...
                ("assistant", "Hello! Thanks for calling Nexus Support. I'd be happy to help you with your billing concerns. Could I start by looking up your account? What's the email address associated with your account?"),
